...
DROP TABLE IF EXISTS `storage_facility`;
...
LOCK TABLES `storage_facility` WRITE;
/*!40000 ALTER TABLE `storage_facility` DISABLE KEYS */;
/*!40000 ALTER TABLE `storage_facility` ENABLE KEYS */;
UNLOCK TABLES;
